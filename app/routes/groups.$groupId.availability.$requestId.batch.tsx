		...
		<div className="mx-auto max-w-4xl pb-12">
			...
			<div className="mb-6">
				...
				<p className="mt-1 text-sm text-slate-600">
					Configure your batch event creation. Each date will create a separate event with one
					...
					<div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
						...
						<div className="space-y-4">
							...
							<div>
								...
								<p className="mt-1 text-xs text-slate-500">Format: HH:MM-HH:MM (24-hour format)</p>
							</div>
						</div>
					</div>
						...
						<div className="flex items-start gap-4">
							...
							<div className="flex-1">
								...
								<p className="mt-1 text-sm text-emerald-700">
									You're about to create <strong>{selectedDates.length} events</strong> with the
									title "<strong>{title}</strong>". One notification email will be sent to the
									group.
								</p>
							</div>
						</div>
